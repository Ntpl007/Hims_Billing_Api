...
namespace Hims_Billing_API.BHISHAK_APP_DB
{
    public partial class bhishak_app_dbContext : DbContext
    {
        ...
        public virtual DbSet<TblFacilityDoctorTariff> TblFacilityDoctorTariffs { get; set; }
        ...
        public virtual DbSet<TblFacilityTariffMaster> TblFacilityTariffMasters { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblFacilityDoctorTariff>(entity =>
            {
                entity.HasKey(e => e.DoctorTariffId)
                    .HasName("PRIMARY");

                entity.ToTable("tbl_facility_doctor_tariff");

                entity.Property(e => e.DoctorTariffId)
                    .HasColumnType("int(11)")
                    .HasColumnName("Doctor_Tariff_Id");
                ...
                entity.Property(e => e.OraganisationId)
                    .HasColumnType("int(11)")
                    .HasColumnName("Oraganisation_Id");

                entity.Property(e => e.OverridenPrice)
                    .HasColumnType("decimal(18,2)")
                    .HasColumnName("Overriden_Price");
            });
            ...
            modelBuilder.Entity<TblFacilityTariffMaster>(entity =>
            {
                entity.HasKey(e => e.FacilityTariffId)
                    .HasName("PRIMARY");

                entity.ToTable("tbl_facility_tariff_master");

                entity.Property(e => e.FacilityTariffId)
                    .HasColumnType("int(11)")
                    .HasColumnName("Facility_Tariff_Id");
